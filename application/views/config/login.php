<div class="row offset-s3">
    ...
    <div class="col s4">
        <div class="logintype normalLogin">
            <div class="checkbox">
                <input type="checkbox" name="email" class="filled-in active" id="filled-in-box" />
...
-->
        ...
        <div class="logintype facebookLogin">
            <div class="checkbox">
                <input type="checkbox" name="Facebook" class="filled-in" id="filled-in-box" />
...
-->
        ...
        <div class="logintype twitterLogin">
            <div class="checkbox">
                <input type="checkbox" name="twitter" class="filled-in" id="filled-in-box" />
...
-->
        ...
        <div class="logintype instagramLogin">
            <div class="checkbox">
                <input type="checkbox" name="instagram" class="filled-in" id="filled-in-box" />
