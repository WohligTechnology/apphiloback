...
<body>
    <div class="padding-top">
        <div class="row">
            <form class="col s12 offset-s0 m6 offset-m3 l4 offset-l4">
                <div class="card">
...
-->
                    ...
                    <div class="card-content">
                        ...
                        <div class="row">
                            <div class="col s12">
                                <button class="btn waves-effect waves-light red darken-1 right" type="submit" name="action">Login</button>
