...
<!--                        <th data-field="article">article</th>-->
    ...
    <div class="createbuttonplacement"><a class="btn-floating btn-large waves-effect waves-light blue darken-4" href="<?php echo site_url("site/createnotification "); ?>"><i class="material-icons">add</i></a>
    </div>
