<div class="row">
    <div class="col s12">
        <div class="col s12 drawchintantable">
           <?php $this->chintantable->createsearch("List of Gallery");?>
...
<!--                        <th data-field="order">Order</th>-->
    ...
    <div class="createbuttonplacement"><a class="btn-floating btn-large waves-effect waves-light blue darken-4" href="<?php echo site_url("site/creategallery "); ?>"><i class="material-icons">add</i></a>
    </div>
