<div class="row">
    ...
    <div class="createbuttonplacement"><a class="btn-floating btn-large waves-effect waves-light green accent-4" href="<?php echo site_url("site/createvideogallery"); ?>"><i class="material-icons">add</i></a>
    </div>
