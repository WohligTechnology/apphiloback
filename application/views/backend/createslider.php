        ...
        <form class="col s12" method="post" action="<?php echo site_url('site/createslidersubmit');?>" enctype="multipart/form-data">
            ...
            <div class=" form-group">
                ...
                <div class="col-sm-4">
                    ...
                    <a href="<?php echo site_url('site/viewslider'); ?>" class="btn btn-secondary waves-effect waves-light">Cancel</a>
                </div>
            </div>
        </form>
</div>
...
<!--
<div id="page-title">
    <a href="<?php echo site_url(" site/viewslider "); ?>" class="btn btn-primary btn-labeled fa fa-arrow-left margined pull-right">Back</a>
