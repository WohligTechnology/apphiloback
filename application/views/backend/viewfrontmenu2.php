...
function drawtable(resultrow) {
     return "<li class='collection-item avatar' data-id='"+resultrow.id+"'><i class='material-icons circle'>folder</i><span class='title'><td>" + resultrow.name + "</td></span><p><td>" + resultrow.status + "</td></p><a class='secondary-content blue-text text-darken-4' href='<?php echo site_url('site/editFrontMenu?id=');?>" + resultrow.id + "'><i class='material-icons'>mode_edit</i></a><a class='secondary-content red-text' style='top:50px;' onclick=\"return confirm('Are you sure you want to delete?');\" href='<?php echo site_url('site/deleteFrontMenu?id='); ?>" + resultrow.id + "'><i class='material-icons propericon'>delete</i></a></li>";
