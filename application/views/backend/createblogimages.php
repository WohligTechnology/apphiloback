<div class="row">
    <div class="col s12">
    <h4 class="pad-left-15">Create Blogimages</h4>
    </div>
        <form class="col s12" method="post" action="<?php echo site_url('site/createblogimagessubmit');?>" enctype="multipart/form-data">
            ...
            <div class=" form-group">
                ...
                <div class="col-sm-4">
                    ...
                    <a href="<?php echo site_url(" site/viewblogimages?id=").$this->input->get('id'); ?>" class="btn btn-secondary waves-effect waves-light">Cancel</a>
                </div>
            </div>
        </form>
</div>
