    ...
    <form class="col s12" method="post" action="<?php echo site_url('site/editblogimagessubmit');?>" enctype="multipart/form-data">
        ...
        <div class=" form-group">
            ...
            <div class="col-sm-4">
                ...
                <a href="<?php echo site_url("site/viewblogimages?id=").$this->input->get('blogid'); ?>" class="btn btn-secondary waves-effect waves-light">Cancel</a>
            </div>
        </div>
    </form>
</div>
...
<section class="panel">
    <header class="panel-heading">
        <h3 class="panel-title">Blogimages Details </h3>
    </header>
    <div class="panel-body">
        <form class='form-horizontal tasi-form' method='post' action='<?php echo site_url("site/editblogimagessubmit");?>' enctype='multipart/form-data'>
            <input type="hidden" id="normal-field" class="form-control" name="id" value="<?php echo set_value('id',$before->id);?>" style="display:none;">
            <div class=" form-group">
