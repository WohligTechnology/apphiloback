<div class="row">
    <div class="col s12">
    <h4 class="pad-left-15">Create Blogvideo</h4>
    </div>
           ...
           <div class="row">
            ...
            <div class=" form-group">
                ...
                <div class="col-sm-4">
                    ...
                    <a href="<?php echo site_url("site/viewblogvideo?id=").$this->input->get('id'); ?>" class="btn btn-secondary waves-effect waves-light">Cancel</a>
                </div>
            </div>
        </form>
</div>
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <a href="<?php echo site_url(" site/viewblogvideo?id=").$this->input->get('id'); ?>" class="btn btn-secondary">Cancel</a>
                                </div>
                            </div>
                    </form>
                    </div>
