<div class="row">
    <div class="col s12">
    <h4 class="pad-left-15">Edit Galleryimage</h4>
    </div>
</div>
<div class="row">
    <form class="col s12" method="post" action="<?php echo site_url('site/editgalleryimagesubmit');?>" enctype="multipart/form-data">
        ...
        <div class=" form-group">
            ...
            <div class="col-sm-4">
                ...
                <a href="<?php echo site_url("site/viewgalleryimage?id=").$this->input->get('galleryid'); ?>" class="btn btn-secondary waves-effect waves-light">Cancel</a>
            </div>
        </div>
    </form>
</div>
