<div class="row">
    <div class="col s12">
    <h4 class="pad-left-15">Create Eventvideo</h4>
    </div>
           ...
           <div class="row">
            ...
            <div class=" form-group">
                ...
                <div class="col-sm-4">
                    ...
                    <a href="<?php echo site_url(" site/vieweventvideo?id=").$this->input->get('id'); ?>" class="btn btn-secondary waves-effect waves-light">Cancel</a>
                </div>
            </div>
        </form>
</div>
...
Create Eventvideo </h3>
                </div>
                <div class="panel-body">
                    <form class='form-horizontal tasi-form' method='post' action='<?php echo site_url("site/createeventvideosubmit");?>' enctype='multipart/form-data'>
                        <div class="panel-body">
                            <div class=" form-group">
