...
<!--
    <div class="createbuttonplacement"><a class="btn-floating btn-large waves-effect waves-light red" href="<?php echo site_url("site/createconfig"); ?>"><i class="material-icons">add</i></a>
    </div>
-->
...
<script>
    function drawtable(resultrow) {
      if (resultrow.type == 1) {
            ...
            return "<tr><td>" + resultrow.id + "</td><td>" + resultrow.title + "</td><td>" + resultrow.type + "</td><td>" + resultrow.text + "</td><td><a class='btn btn-primary btn-xs waves-effect waves-light orange lighten-1' href='<?php echo site_url('site/editconfig?id=');?>" + resultrow.id + "'><i class='material-icons propericon'>system_update_alt</i></a></td></tr>";
    }
