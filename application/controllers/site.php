...

{
	...
	function createUserSubmit()
	{
		...
		else
		{
			...
			if ($this->User_Model->create($name, $email, $password, $accesslevel, $status, $socialid, $logintype, $image, $json, $contact, $address, $eventnotification, $photonotification, $videonotification, $blognotification, $coverimage) == 0) $data['alerterror'] = "New User Could Not Be Created.";
	...
	function editUserSubmit()
	{
		...
		else
		{
			...
			if ($this->User_Model->edit($id, $name, $email, $password, $accesslevel, $status, $socialid, $logintype, $image, $json, $contact, $address, $eventnotification, $photonotification, $videonotification, $blognotification, $coverimage) == 0) $data['alerterror'] = "User Editing Was Unsuccesful";
	...
	function createArticlesSubmit()
	{
		...
		else
		{
			...
			if ($this->Articles_Model->create($status, $title, $json, $content, $image) == 0) $data["alerterror"] = "New Page Could Not Be Created.";
			else $data["alertsuccess"] = "Page Created Successfully.";
	...
	function editArticlessubmit()
	{
		...
		else
		{
			...
			if ($this->Articles_Model->edit($id, $status, $title, $json, $content, $timestamp, $image) == 0) $data["alerterror"] = "New Page Could Not Be Updated.";
			else $data["alertsuccess"] = "Page Updated Successfully.";
			if ($id != 1)
			{
				$data["redirect"] = "site/viewArticles";
				$this->load->view("redirect", $data);
	...
	function createFrontMenusubmit()
	{
		$access = array(
			"1"
		);
		...
		else
		{
			...
			if ($this->FrontMenu_Model->create($order, $parent, $status, $name, $json, $image, $linktype, $icon, $event, $blog, $video, $article, $gallery, $typeid) == 0) $data["alerterror"] = "New Navigation could not be created.";
			else $data["alertsuccess"] = "Navigation created Successfully.";
	...
	function editFrontMenuSubmit()
	{
		...
		else
		{
			...
			if ($this->FrontMenu_Model->edit($id, $order, $parent, $status, $name, $json, $image, $linktype, $icon, $event, $blog, $video, $article, $gallery, $typeid) == 0) $data["alerterror"] = "New Navigation Could Not Be Updated.";
			else $data["alertsuccess"] = "Navigation Updated Successfully.";
			$data["redirect"] = "site/viewFrontmenu";
			$this->load->view("redirect", $data);
		}
	}
	...
	function createGallerySubmit()
	{
		...
		else
		{
			...
			if ($this->Gallery_Model->create($order, $status, $name, $json, $image) == 0) $data["alerterror"] = "New Image Gallery could not be created.";
			else $data["alertsuccess"] = "Image Gallery created Successfully.";
	...
	function editGallerySubmit()
	{
		...
		else
		{
			...
			if ($this->Gallery_Model->edit($id, $order, $status, $name, $json, $timestamp, $image) == 0) $data["alerterror"] = "New Image Gallery Could Not Be Updated.";
			else $data["alertsuccess"] = "Image Gallery Updated Successfully.";
			$data["redirect"] = "site/viewGallery";
			$this->load->view("redirect", $data);
		}
	}
	...
	function createGalleryImageSubmit()
	{
		$access = array(
			"1"
		);
		...
		else
		{
			...
			if ($this->GalleryImage_Model->create($gallery, $order, $status, $image, $alt) == 0) $data["alerterror"] = "New Image Gallery Image could not be created.";
			else $data["alertsuccess"] = "Image Gallery Image created Successfully.";
	...
	function editGalleryImagesubmit()
	{
		$access = array(
			"1"
		);
		...
		else
		{
			...
			if ($this->GalleryImage_Model->edit($id, $gallery, $order, $status, $image, $alt) == 0) $data["alerterror"] = "New Image Gallery Image Could Not Be Updated.";
			else $data["alertsuccess"] = "Image Gallery Image Updated Successfully.";
			$data["redirect"] = "site/viewGalleryImage?id=" . $gallery;
			$this->load->view("redirect2", $data);
		}
	}
	...
	function createVideoGallerySubmit()
	{
		$access = array(
			"1"
		);
		...
		else
		{
			...
			if ($this->VideoGallery_Model->create($order, $status, $name, $json, $subtitle) == 0) $data["alerterror"] = "New Video Gallery could not be created.";
			else $data["alertsuccess"] = "Video Gallery created Successfully.";
	...
	function editVideoGallerySubmit()
	{
		$access = array(
			"1"
		);
		...
		else
		{
			...
			$timestamp = $this->input->get_post("timestamp");
			$subtitle = $this->input->get_post("subtitle");
			if ($this->VideoGallery_Model->edit($id, $order, $status, $name, $json, $timestamp, $subtitle) == 0) $data["alerterror"] = "New Video Gallery Could Not Be Updated.";
			else $data["alertsuccess"] = "Video Gallery Updated Successfully.";
			$data["redirect"] = "site/viewVideoGallery";
			$this->load->view("redirect", $data);
		}
	}
	...
	function viewVideoGalleryVideo()
	{
		$access = array(
			"1"
		);
	...
	function createVideoGalleryVideo()
	{
		$access = array(
			"1"
		);
	...
	function createVideoGalleryVideoSubmit()
	{
		$access = array(
			"1"
		);
		...
		else
		{
			...
			$alt = $this->input->get_post("alt");
			if ($this->VideoGalleryVideo_Model->create($order, $status, $videogallery, $url, $alt) == 0) $data["alerterror"] = "New Video Gallery Video Could Not Be created.";
			else $data["alertsuccess"] = "Video Gallery Video created Successfully.";
	...
	function editVideoGalleryVideo()
	{
		$access = array(
			"1"
		);
	...
	function editVideoGalleryVideoSubmit()
	{
		$access = array(
			"1"
		);
		...
		else
		{
			...
			$url = $this->input->get_post("url");
			$alt = $this->input->get_post("alt");
			if ($this->VideoGalleryVideo_Model->edit($id, $order, $status, $videogallery, $url, $alt) == 0) $data["alerterror"] = "New Video Gallery Video Could Not Be Updated.";
			else $data["alertsuccess"] = "Video Gallery Video Updated Successfully.";
			$data["redirect"] = "site/viewVideoGalleryVideo?id=" . $videogallery;
			$this->load->view("redirect2", $data);
		}
	}
	...
	function deleteVideoGalleryVideo()
	{
		$access = array(
			"1"
		);
	...
	function createEventsSubmit()
	{
		...
		else
		{
			...
			if ($this->Events_Model->create($status, $title, $timestamp, $content, $venue, $image, $startdate, $starttime) == 0) $data["alerterror"] = "New Event could not be created.";
			else $data["alertsuccess"] = "Event created Successfully.";
	...
	function editEventsSubmit()
	{
		...
		else
		{
			...
			if ($this->Events_Model->edit($id, $status, $title, $timestamp, $content, $venue, $image, $startdate, $starttime) == 0) $data["alerterror"] = "New Event Could Not Be Updated.";
			else $data["alertsuccess"] = "Event Updated Successfully.";
			$data["redirect"] = "site/viewEvents";
			$this->load->view("redirect", $data);
		}
	}
	...
	function createEventVideoSubmit()
	{
		$access = array(
			"1"
		);
		...
		else
		{
			...
			$order = $this->input->get_post("order");
			$url = $this->input->get_post("url");
			if ($this->EventVideo_Model->create($event, $videogallery, $status, $order, $url) == 0) $data["alerterror"] = "New Event Video could not be created.";
			else $data["alertsuccess"] = "Event Video created Successfully.";
	...
	function editEventVideoSubmit()
	{
		...
		else
		{
			...
			$order = $this->input->get_post("order");
			$url = $this->input->get_post("url");
			if ($this->EventVideo_Model->edit($id, $event, $videogallery, $status, $order, $url) == 0) $data["alerterror"] = "New Event Video Could Not Be Updated.";
			else $data["alertsuccess"] = "Event Video Updated Successfully.";
			$data["redirect"] = "site/viewEventVideo?id=" . $event;
			$this->load->view("redirect2", $data);
		}
	}
	...
	function createEventImagesSubmit()
	{
		$access = array(
			"1"
		);
		...
		else
		{
			...
			if ($this->EventImages_Model->create($event, $status, $order, $image) == 0) $data["alerterror"] = "New Event Images could not be created.";
			else $data["alertsuccess"] = "Event Image created Successfully.";
	...
	function editEventImagesSubmit()
	{
		$access = array(
			"1"
		);
		...
		else
		{
			...
			if ($this->EventImages_Model->edit($id, $event, $status, $order, $image) == 0) $data["alerterror"] = "New Event Image Could Not Be Updated.";
			else $data["alertsuccess"] = "Event Images Updated Successfully.";
			$data["redirect"] = "site/viewEventImages?id=" . $event;
			$this->load->view("redirect2", $data);
		}
	}
	...
	function createEnquirySubmit()
	{
		...
		else
		{
			...
			$timestamp = $this->input->get_post("timestamp");
			$content = $this->input->get_post("content");
			if ($this->Enquiry_Model->create($user, $name, $email, $title, $timestamp, $content) == 0) $data["alerterror"] = "New enquiry could not be created.";
			else $data["alertsuccess"] = "enquiry created Successfully.";
	...
	function editEnquirySubmit()
	{
		...
		else
		{
			...
			$timestamp = $this->input->get_post("timestamp");
			$content = $this->input->get_post("content");
			if ($this->Enquiry_Model->edit($id, $user, $name, $email, $title, $timestamp, $content) == 0) $data["alerterror"] = "New enquiry Could Not Be Updated.";
			else $data["alertsuccess"] = "enquiry Updated Successfully.";
			$data["redirect"] = "site/viewEnquiry";
			$this->load->view("redirect", $data);
		}
	}
	...
	function createNotificationSubmit()
	{
		$access = array(
			"1"
		);
		...
		if ($this->Notification_Model->create($linktype, $event, $video, $gallery, $article, $status, $blog, $link, $content, $image) == 0) $data["alerterror"] = "New notification could not be created.";
		else $data["alertsuccess"] = "notification created Successfully.";
	...
	function editNotificationSubmit()
	{
		...
		else
		{
			...
			if ($this->Notification_Model->edit($id, $linktype, $event, $video, $gallery, $article, $status, $blog, $link, $content, $image, $timestamp) == 0) $data["alerterror"] = "New notification Could Not Be Updated.";
			else $data["alertsuccess"] = "notification Updated Successfully.";
			$data["redirect"] = "site/viewNotification";
			$this->load->view("redirect", $data);
		}
	}
	...
	function createNotificationUserSubmit()
	{
		$access = array(
			"1"
		);
		...
		else
		{
			...
			if ($this->NotificationUser_Model->create($notification, $user, $timestamp, $timestamp_receive) == 0) $data["alerterror"] = "New Notificationuser could not be created.";
			else $data["alertsuccess"] = "Notificationuser created Successfully.";
	...
	function editNotificationUserSubmit()
	{
		$access = array(
			"1"
		);
		...
		else
		{
			...
			$timestamp = $this->input->get_post("timestamp");
			$timestamp_receive = $this->input->get_post("timestamp_receive");
			if ($this->NotificationUser_Model->edit($id, $notification, $user, $timestamp, $timestamp_receive) == 0) $data["alerterror"] = "New notificationuser Could Not Be Updated.";
			else $data["alertsuccess"] = "notificationuser Updated Successfully.";
			$data["redirect"] = "site/viewNotificationUser?id=" . $notification;
			$this->load->view("redirect2", $data);
		}
	}
	...
	function deleteNotificationUser()
	{
		$access = array(
			"1"
		);
	...
	function createBlogSubmit()
	{
		...
		else
		{
			...
			if ($this->Blog_Model->create($title, $json, $content, $url, $image) == 0) $data["alerterror"] = "New blog could not be created.";
			else $data["alertsuccess"] = "blog created Successfully.";
	...
	function editBlogSubmit()
	{
		...
		else
		{
			...
			if ($this->Blog_Model->edit($id, $title, $json, $content, $timestamp, $url, $image) == 0) $data["alerterror"] = "New blog Could Not Be Updated.";
			else $data["alertsuccess"] = "blog Updated Successfully.";
			$data["redirect"] = "site/viewBlog";
			$this->load->view("redirect", $data);
		}
	}
	...
	function createBlogVideoSubmit()
	{
		$access = array(
			"1"
		);
		...
		else
		{
			...
			$order = $this->input->get_post("order");
			$video = $this->input->get_post("video");
			if ($this->BlogVideo_Model->create($blog, $status, $order, $video) == 0) $data["alerterror"] = "New blogvideo could not be created.";
			else $data["alertsuccess"] = "blogvideo created Successfully.";
	...
	function editBlogVideoSubmit()
	{
		...
		else
		{
			...
			$order = $this->input->get_post("order");
			$video = $this->input->get_post("video");
			if ($this->BlogVideo_Model->edit($id, $blog, $status, $order, $video) == 0) $data["alerterror"] = "New blogvideo Could Not Be Updated.";
			else $data["alertsuccess"] = "blogvideo Updated Successfully.";
			$data["redirect"] = "site/viewBlogVideo?id=" . $blog;
			$this->load->view("redirect2", $data);
		}
	}
	...
	function createBlogImagesSubmit()
	{
		$access = array(
			"1"
		);
		...
		else
		{
			...
			if ($this->BlogImages_Model->create($blog, $status, $order, $image) == 0) $data["alerterror"] = "New blogimages could not be created.";
			else $data["alertsuccess"] = "blogimages created Successfully.";
	...
	function editBlogImagesSubmit()
	{
		...
		else
		{
			...
			if ($this->BlogImages_Model->edit($id, $blog, $status, $order, $image) == 0) $data["alerterror"] = "New blogimages Could Not Be Updated.";
			else $data["alertsuccess"] = "blogimages Updated Successfully.";
			$data["redirect"] = "site/viewBlogImages?id=" . $blog;
			$this->load->view("redirect2", $data);
		}
	}
	...
	function createSliderSubmit()
	{
		...
		else
		{
			...
			if ($this->Slider_Model->create($alt, $status, $order, $image) == 0) $data["alerterror"] = "New slider could not be created.";
			else $data["alertsuccess"] = "slider created Successfully.";
	...
	function editSliderSubmit()
	{
		...
		else
		{
			...
			if ($this->Slider_Model->edit($id, $alt, $status, $order, $image) == 0) $data["alerterror"] = "New slider Could Not Be Updated.";
			else $data["alertsuccess"] = "slider Updated Successfully.";
			$data["redirect"] = "site/viewSlider";
			$this->load->view("redirect", $data);
		}
	}
	...
	function createConfigSubmit()
	{
		...
		else
		{
			...
			$content = $this->input->get_post("content");
			if ($this->Config_Model->create($title, $content, $text, $type) == 0) $data["alerterror"] = "New config could not be created.";
			else $data["alertsuccess"] = "config created Successfully.";
	...
	function editConfigSubmit()
	{
		...
		{
			$image = $preimage;
			if ($this->Config_Model->edit($id, $title, $content, $text, $image, $type, $description) == 0) $data["alerterror"] = "New config Could Not Be Updated.";
			else $data["alertsuccess"] = "config Updated Successfully.";
			$data["redirect"] = "site/viewConfig";
			$this->load->view("redirect", $data);
		}
	...
	function editHomeSubmit()
	{
		...
		$id = $this->input->get_post("id");
		$content = $this->input->get_post("content");
		if ($this->Slider_Model->editHome($id, $content) == 0) $data["alerterror"] = "New home Could Not Be Updated.";
		else $data["alertsuccess"] = "home Updated Successfully.";
